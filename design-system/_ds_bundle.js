...
// Chronicles Desktop App/app.jsx
try { (() => {
...
chMount();
})(); } catch (e) { __ds_ns.__errors.push({ path: "Chronicles Desktop App/app.jsx", error: String((e && e.message) || e) }); }
